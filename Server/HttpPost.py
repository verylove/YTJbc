...
class SimpleHTTPRequestHandler(BaseHTTPServer.BaseHTTPRequestHandler):
    ...
    def deal_post_data(self):
        ...
        point = re.findall(r'Content-Disposition.*name="point"; filename="(.*)"', line)
        ...
        if  ini:
            ...
            fn = ['point.txt']
            print fn
            return self.uploadPoint(fn,line,remainbytes,boundary)
        else:
    ...
    def uploadPoint(self,fn,line,remainbytes,boundary):
        path = self.translate_path(self.path)
        osType = platform.system()
        try:
            if osType == "Linux":
    ...
    def display_page(self, path):
        ...
        #f.write("配置信息：<textarea name=\"textarea\" id=\"textarea\" cols=\"45\" rows=\"5\"></textarea><br/>")
        #f.write("姓名：<input type=\"text\" name=\"username\" id=\"username\" /><br/>")
