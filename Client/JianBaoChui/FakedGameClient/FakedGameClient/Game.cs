...
namespace FakedGameClient
{
    public partial class Game
    {
        ...
        GamePlayer _champion = null;
        public FakedGameClient.GamePlayer Champion
        {
            get { return _champion; }
            set { _champion = value; }
        }

        bool _inPlayerList = false;
        public FakedGameClient.GamePlayer Me
        {
            get { return _playerInfo; }
            set { _playerInfo = value; }
        }

        List<GamePlayer> _allPlayers = null;
        ...
        List<GamePlayer> _lastPlayerList = null;
        ...
        FormGame _mainForm = null;

        public bool _showSocketLog = false;
